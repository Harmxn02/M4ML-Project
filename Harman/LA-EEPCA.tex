...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/eigenvector-visualisation.png}
...
We take the example matrix \(A\) from the previous section:
\[
	A = \begin{bmatrix}
		2 & 2 \\
		-4 & 8
...
\subsubsection{Standardise the dataset}
...
\subsubsection{Calculate the covariance matrix}
...
\subsubsection{Perform eigen-decomposition on the covariance matrix}
...
\subsubsection{Sort eigenvalues and select top \(k\) eigenvectors}
