...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.6\textwidth]{images/LINEAR_ALGEBRA/eigenvector-visualisation.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.8\textwidth]{images/LINEAR_ALGEBRA/plot-output-lines.png}}
