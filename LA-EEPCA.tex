...
\begin{figure}
	\centering
	\includegraphics[width=0.6\textwidth]{images/LINEAR_ALGEBRA/eigenvector-visualisation.png}
...
We standardise the dataset, performed PCA, and then used a helper function to train a logistic regression model using the first \(k\) principal components. We evaluate the each of the models using 5-fold cross-validation and record the mean accuracy for each \(k\).
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{images/LINEAR_ALGEBRA/plot-output-lines.png}
