...
We went through the document with all possible topics, highlighted the ones we found interesting, and then discussed which two topics we liked the most for each of the two parts.
...
Throughout the project we mainly communicated through Discord. We organised scheduled calls, that lasted for anywhere between 10{\textendash}30 minutes to give each other an update and review each other's progress.
